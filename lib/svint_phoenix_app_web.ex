defmodule SvintPhoenixAppWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SvintPhoenixAppWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/svint_phoenix_app_web/templates",
        namespace: SvintPhoenixAppWeb
